...
try {
       ...
       conn.send2Button(m.chat, `Halo Kak ${conn.getName(m.sender)} Ada yang Bisa saya Bantu?`, userbot.packname, `❌ Tidak`, `butno`, `✔️ Iya`, `butya`, {quoted: m})
        }
    } catch (e) {
        return
    }
